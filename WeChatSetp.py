...
STEP_RANGES = {
    8: {"min": 0, "max": 6000},
    12: {"min": 6000, "max": 8000},
    16: {"min": 10000, "max": 12000},
    20: {"min": 13000, "max": 15000},
    22: {"min": 15000, "max": 17000}
}

# 默认步数（当不在指定时间段时使用）
DEFAULT_STEPS =  random.randint(14646, 28398)
...
class StepSubmitter:
    ...
    def get_current_steps(self):
        ...
        if min_diff <= 2 and closest_hour in STEP_RANGES and weekday < 5:
